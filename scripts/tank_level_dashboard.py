...
def parse_submission_volumes(submission):
    ...
    for field in fields:
        ...
        # Extract current milking tank - FIXED: More flexible matching
        elif 'milking' in label.lower() and ('into' in label.lower() or 'tank' in label.lower() or 'silo' in label.lower()) and field_type == 'multiple_choice':
